...
\n\
【出演者と役割】\n\
四国めたん（解説役）：知的でちょっとツンデレ。論文の内容を中心に解説する。解説の根拠はできる限りPDF本文を参照し、PDFに書かれていない補足知識が必要なときはGeminiの一般知識を使ってよいが「論文には書かれていないけど背景として」などと区別する。語尾に「〜わ」「〜かしら」「〜ね」を自然に混ぜる。\n\
ずんだもん（聞き役）：元気いっぱいで好奇心旺盛。大学生程度の知識を持つが論文の専門的な部分はわからないことがある。わからないことや気になることがあれば素直に質問する。語尾に「〜なのだ」「〜のだ」を自然に混ぜる。\n\
\n\
【番組の雰囲気】\n\
めたんがメインで論文を解説し、ずんだもんが相槌・疑問・驚きで会話を転がす。「この論文、何がすごいの？」「わかった！つまり〜ってこと？」のように素直な反応でテンポを作る。例え話や身近なたとえを積極的に使う。技術的な詳細よりも「なぜ面白いか」「世界が変わるとしたら？」を優先する。\n\
\n\
【PDF外の補足知識】\n\
めたんの解説は第一にPDF本文を参照する。PDFに書かれていない専門的背景・歴史・類似概念が必要なときはGeminiの一般知識で補ってよいが、PDFの主張と外部知識を混同しない。「論文ではこう言っているわ」「背景として知っておくと」のように区別する。PDFにない新事実を論文の結論として断定しない。\n\
\n\
【出力形式】\n\
以下のJSON形式のみで返答すること。それ以外は出力しない：\n\
{{\"chunks\":[{{\"title\":\"...\",\"page_start\":1,\"page_end\":{total_pages},\"source_text\":\"...\",\"key_points\":[\"...\"],\"summary_text\":\"...\",\"dialogue_turns\":[{{\"speaker\":\"metan\",\"text\":\"...\"}},{{\"speaker\":\"zundamon\",\"text\":\"...\"}}],\"qa_context\":\"...\"}}]}}\n\
\n\
【チャンク構成】\n\
chunksは1つだけ生成する。page_start=1、page_end={total_pages}。titleはラジオ番組らしい日本語タイトルにする。\n\
\n\
【dialogue_turnsの書き方】\n\
speakerは「zundamon」または「metan」のみ使う。めたんから始め、交互に20〜35ターン生成する。各ターンは1〜3文、自然な会話の流れにする。\n\
冒頭はめたんの「はいはい、今日もペーパーラジオ始めるわよ。今日の論文はね〜」のような入りにする。\n\
ずんだもんの最初の反応は「えっ、なんかすごそうなのだ！どんな内容なのだ？」などの好奇心全開のリアクションにする。\n\
本編はめたんの解説とずんだもんの質問・驚き・確認の掛け合いで進める。ずんだもんが理解できないときは「ちょっと待って、つまりどういうことなのだ？」と素直に聞く。\n\
全体の文字数は3000〜4500文字を目安にする。\n\
締めはめたんの「以上、今日の論文解説だったわ。また次回もよろしくね」で終わる。\n\
\n\
【VOICEVOX制約】\n\
